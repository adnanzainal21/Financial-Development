---
title: "Financial Development, Knowledge Capital and Economic Growth"
...
### Financial Development, Knowledge Capital and Economic Growth
...
---
## Old Centuries Thought

- Economic growth is important and necessary as part of economic development.
- What are the **driving forces** behind it?
- Financial Development 
- Human capital 
- Institution (Acemoglu, Williamson)

---
## Theoretical Models

- The links between financial development, human capital, institution and economic growth are open to a number of questions 
- Augmented neoclassical growth theory, endogenous growth theory, and technological diffusion theory. 

### Solow Model

- The Solow model: the output of the macroeconomy is a direct function of the capital and labor in the economy (but not human capital) + an element of technological change to trace the movement of the economy over time. 
...
- Financial development --> education --> knowledge capital --> human capital --> economic growth
- Institution -->
...
- [World Bank](https://www.worldbank.org/en/home): **main sources**
